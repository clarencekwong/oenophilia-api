...
Food_wine.create({food_id: 1, wine_id: 1})
Food_wine.create({food_id: 2, wine_id: 2})
Food_wine.create({food_id: 3, wine_id: 3})
Food_wine.create({food_id: 4, wine_id: 4})
Food_wine.create({food_id: 5, wine_id: 5})
Food_wine.create({food_id: 6, wine_id: 6})
Food_wine.create({food_id: 7, wine_id: 7})
Food_wine.create({food_id: 8, wine_id: 8})
Food_wine.create({food_id: 9, wine_id: 1})
Food_wine.create({food_id: 10, wine_id: 2})
Food_wine.create({food_id: 11, wine_id: 3})
Food_wine.create({food_id: 12, wine_id: 4})
Food_wine.create({food_id: 13, wine_id: 5})
Food_wine.create({food_id: 14, wine_id: 6})
